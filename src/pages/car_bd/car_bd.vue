          ...
          <view class="use-list">
            <view class="renbox">
              <image
                :src="
                  use_user == 1
                    ? '../../static/image/people_a@3x.png'
                    : '../../static/image/people_sa@3x.png'
                "
                @click="aliassss(1)"
              ></image>
            ...
            <view class="renbox">
              <image
                :src="
                  use_user == 2
                    ? '../../static/image/people_b@3x.png'
                    : '../../static/image/people_sb@3x.png'
                "
                @click="aliassss(2)"
              ></image>
            ...
            <view class="renbox">
              <image
                :src="
                  use_user == 3
                    ? '../../static/image/people_c@3x.png'
                    : '../../static/image/people_sc@3x.png'
                "
                @click="aliassss(3)"
              ></image>
            ...
            <view class="renbox">
              <image
                :src="
                  use_user == 4
                    ? '../../static/image/people_d@3x.png'
                    : '../../static/image/people_sd@3x.png'
                "
                @click="aliassss(4)"
              ></image>
            ...
            <view class="renbox">
              <image
                :src="
                  use_user == 5
                    ? '../../static/image/people_e@3x.png'
                    : '../../static/image/people_se@3x.png'
                "
                @click="aliassss(5)"
              ></image>
...
export default {
  ...
  onLoad(e) {
    ...
    if (e.deviceid) {
      ...
      common.request("machine/bind_fetch", { deviceid: e.deviceid }, function (
        res
      ) {
        console.log(res);
