	...
	<view>
		<form @submit="submit">
			<view class="time-box">
				...
				<view class="week-box">
					<view class="week" @click="choseWeek(k)" :class="item.class" v-for="(item,k) in week">{{item.name}}</view>
				</view>
			</view>
			<view class="time-box">
				<view class="title">每周工作日:</view>
				<view class="date-num">
					<uni-segmented-control :current="current" :values="items" @clickItem="onClickItem" active-color="#37f"></uni-segmented-control>
				</view>
				...
				<view style="margin-top: 30rpx;" v-for="count in timeItem">
					<view class="time-chose-box">
						<view class="time">
							<picker :name="'s_start_'+count" mode="time" :value="timeChose[count].s_start" @change="bindTimeChange($event,count,'s_start')">
								<image src="../../static/image/timming@3x.png"></image>
								<text>{{timeChose[count].s_start}}</text>
							</picker>
						</view>
						<view class="time">
							<picker :name="'s_time_'+count" mode="time" :value="timeChose[count].s_time" @change="bindTimeChange($event,count,'s_time')">
								<image src="../../static/image/timming@3x.png"></image>
								<text>{{timeChose[count].s_time}}</text>
							</picker>
						</view>
						<view class="time">
							<picker :name="'s_end_'+count" mode="time" :value="timeChose[count].s_end" @change="bindTimeChange($event,count,'s_end')">
								<image src="../../static/image/timming@3x.png"></image>
					...
					<view class="time-chose-box">
						<view class="time">
							<picker :name="'e_start_'+count" mode="time" :value="timeChose[count].e_start" @change="bindTimeChange($event,count,'e_start')">
								<image src="../../static/image/timming@3x.png"></image>
								<text>{{timeChose[count].e_start}}</text>
							</picker>
						</view>
						<view class="time">
							<picker :name="'e_time_'+count" mode="time" :value="timeChose[count].e_time" @change="bindTimeChange($event,count,'e_time')">
								<image src="../../static/image/timming@3x.png"></image>
								<text>{{timeChose[count].e_time}}</text>
							</picker>
						</view>
						<view class="time">
							<picker :name="'e_end_'+count" mode="time" :value="timeChose[count].e_end" @change="bindTimeChange($event,count,'e_end')">
								<image src="../../static/image/timming@3x.png"></image>
			...
			<view class="time-box">
				<view class="title">是否开启加班:
					<switch name="overtime" :checked="overtimeCheck" @change="overtime" style="transform:scale(0.7);float: right;" />
				</view>
				<view style="margin-top: 30rpx;" v-if="overtimeCheck">
					<view class="time-chose-box">
						<view class="time">
							<picker name="o_s_start" mode="time" :value="overtimeArr.s_start" @change="bindTimeChange($event,0,'s_start')">
								<image src="../../static/image/timming@3x.png"></image>
								<text>{{overtimeArr.s_start}}</text>
							</picker>
						</view>
						<view class="time">
							<picker name="o_s_time" mode="time" :value="overtimeArr.s_time" @change="bindTimeChange($event,0,'s_time')">
								<image src="../../static/image/timming@3x.png"></image>
								<text>{{overtimeArr.s_time}}</text>
							</picker>
						</view>
						<view class="time">
							<picker name="o_s_end" mode="time" :value="overtimeArr.s_end" @change="bindTimeChange($event,0,'s_end')">
								<image src="../../static/image/timming@3x.png"></image>
					...
					<view class="time-chose-box">
						<view class="time">
							<picker name="o_end_time" mode="time" :value="overtimeArr.end_time" @change="bindTimeChange($event,0,'end_time')">
								<image src="../../static/image/timming@3x.png"></image>
			...
			<view class="time-box">
				<view class="title">是否开启法定节假日排休:
					<switch name="holiday" :checked="holidayChecked" @change="holiday" style="transform:scale(0.7);float: right;" />
				</view>
			</view>
