<template>
	<view>
		<uni-nav-bar left-icon="back" :fixed="true" :status-bar="true" title="设备绑定" @clickLeft="goBack"></uni-nav-bar>
		<view class="page">
			<view class="device">
				<view class="info">
					<view class="logo">
						<image :src="urlbtx?'../../static/image/weatch@2x.png':'../../static/image/shebei4.png'"></image>
					</view>
				...
				<view class="item">
					...
					<view class="subtitle">
						<input class="uni-input" v-model="deviceid" type="number" placeholder="请输入设备号" maxlength="16" />
					</view>
				</view>
